...
- Dell, Lenovo, HP: 15–20%+ list-price increases across 2026, with more warned for H2. On its August 26, 2026 earnings call HP's CFO said the company "expect[s] to continue to increase pricing as input costs rise," that memory and storage now account for roughly **35% of a PC's bill of materials** (up from 15–18%), and that the cheaper inventory that cushioned H1 pricing is used up. DRAM contract prices rose ~95% in Q1 and ~89% in Q2 2026. IDC and HP both expect PC unit shipments to fall by "high teens" percentages in H2 2026 — OEMs are shipping fewer, pricier machines and dropping 8 GB base configs to 4-or-8 GB on the very cheapest models rather than raising them.
